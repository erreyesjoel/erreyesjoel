...
- Diseño y desarrollo de **REST APIs** con Laravel y Django REST Framework
...
## 🧠 Ciberseguridad – Formación complementaria
Graduado en la especialidad en Ciberseguridad, enfocada en la protección, gestión y fortalecimiento de sistemas informáticos.
...
## 🖥️ Sistemas operativos – Mis entornos de trabajo
...
- **ERP de Gestión de Socios e Inventario** — Aplicación Full Stack con Laravel, MariaDB y Docker, desarrollada en equipo de 2 para la Agrupació Astronòmica de Terrassa. Utilizada por más de 50 socios. Código privado (proyecto de cliente real) — capturas y detalles en el [portfolio](https://joelerreyes-portfolio.netlify.app/).
- **Borsa de Treball – Institut Montserrat Roig** — Plataforma Full Stack con Vue.js y Laravel, en producción, utilizada por más de 120 usuarios del instituto. Código privado — [demo en vídeo](https://www.youtube.com/watch?v=qzG-khej7M0) y detalles en el [portfolio](https://joelerreyes-portfolio.netlify.app/).
- [EasyTrip](https://github.com/erreyesjoel/EasyTrip) — Gestión y reservas de paquetes turísticos.
...
- 🌐 [Portfolio](https://joelerreyes-portfolio.netlify.app/)
